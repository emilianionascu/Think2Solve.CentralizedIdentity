...
using Think2Solve.CentralizedIdentity.Web.Models;

namespace Think2Solve.CentralizedIdentity.Web.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        [ClaimsPrincipalPermission(SecurityAction.Demand, Operation = "LogOff", Resource = "User")]
